...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for fitness-content" ON storage.objects FOR SELECT USING (bucket_id = 'fitness-content');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for fitness-content" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'fitness-content');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for fitness-content" ON storage.objects FOR UPDATE USING (bucket_id = 'fitness-content');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for fitness-content" ON storage.objects FOR DELETE USING (bucket_id = 'fitness-content');`
    ];
